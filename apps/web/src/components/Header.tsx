          ...
          <div className="flex items-center gap-2">
            {!isInstalled && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 flex items-center gap-1 text-xs font-display font-bold transition-all shadow-sm active:scale-95 cursor-pointer"
              >
